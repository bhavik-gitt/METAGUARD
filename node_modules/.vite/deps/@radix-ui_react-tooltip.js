...
var TooltipProvider = (props) => {
  ...
  const [isOpenDelayed, setIsOpenDelayed] = React10.useState(true);
  const isPointerInTransitRef = React10.useRef(false);
  const skipDelayTimerRef = React10.useRef(0);
  React10.useEffect(() => {
  ...
  return (0, import_jsx_runtime6.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayed,
      delayDuration,
      onOpen: React10.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        setIsOpenDelayed(false);
      }, []),
      onClose: React10.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React10.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React10.useRef(false);
  ...
  const stateAttribute = React10.useMemo(() => {
  ...
  const handleDelayedOpen = React10.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_jsx_runtime6.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime6.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React10.useCallback(() => {
...
var TooltipTrigger = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React10.useRef(false);
    const handlePointerUp = React10.useCallback(() => isPointerDownRef.current = false, []);
    React10.useEffect(() => {
...
var TooltipContentHoverable = React10.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React10.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React10.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React10.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React10.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React10.forwardRef(
  (props, forwardedRef) => {
